"""
Pre-process very large, "sentiment 140" from http://help.sentiment140.com/for-students/

It buffers data so we can run inside out own computer - memory size problems are close in this
learning journey

this file prepares a large csv file for use in a NN
        ...
        try:
            ...
            for line in f:
                ...
                if (counter / 2500.0).is_integer():
                    ...
                    print("Counter:", counter, "Lexicon Length:", len(lexicon))
